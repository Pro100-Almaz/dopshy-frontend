...
import FieldPhotoGallery from './components/FieldPhotoGallery.vue'
...
<template>
  <div class="min-h-screen bg-gray-50 text-gray-800" style="font-family: Rubik, sans-serif">
    ...
    >
      <div
        class="grid gap-8 xl:gap-10 lg:grid-cols-[minmax(0,1fr)_22rem] xl:grid-cols-[minmax(0,1fr)_24rem]"
      >
        <!-- Main column -->
        <div>
          <FieldPhotoGallery v-model:active-photo="activePhoto" :field="field" class="lg:hidden" />
          ...
          <div class="sticky top-24 space-y-4">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-sm">
              ...
              <div v-if="store.count === 0" class="mt-6 text-sm text-gray-500">
                Выберите удобные слоты в расписании.
              </div>
