  ...
  <div>
    ...
    <div class="grid grid-cols-3 gap-2.5 sm:grid-cols-4 lg:grid-cols-5">
      <button
        ...
        class="flex flex-col items-center justify-center rounded-md border px-2 py-2.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-success-600"
        :class="
